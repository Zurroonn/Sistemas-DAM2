...
class azp_inmuebles(models.Model):
    _name = "azp_propiedades_inmuebles"  # Se creará una tabla llamada azp_inmuebles
    ...
    tipos_id = fields.Many2one("azp_tipos_inmuebles", string="Tipo")
    etiquetas_ids = fields.Many2many("azp_etiquetas_inmuebles", string="Etiquetas")
    ofertas_ids = fields.One2many("azp_ofertas_inmuebles", "inmueble_id", string="Ofertas")
